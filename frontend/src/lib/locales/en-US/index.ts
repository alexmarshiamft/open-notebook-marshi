export const enUS = {
  ...
  connectionErrors: {
    ...
    apiDesc: "The MarshiLM API server could not be reached",
    ...
    docLink: "MarshiLM Documentation",
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow MarshiLM to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of MarshiLM is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across MarshiLM",
    missingRequiredModels: "Missing required models: {models}. MarshiLM may not function properly without these.",
  ...
  apiKeys: {
    ...
    description: "Store API keys securely in the database to enable AI providers in MarshiLM.",
