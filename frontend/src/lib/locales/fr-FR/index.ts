export const frFR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Le serveur API de MarshiLM est injoignable",
    ...
    docLink: "Documentation de MarshiLM",
  ...
  settings: {
    ...
    filesHelp: "Une fois vos fichiers téléchargés et traités, ils ne sont plus nécessaires. La plupart des utilisateurs devraient autoriser MarshiLM à supprimer automatiquement les fichiers du dossier de téléchargement.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Une nouvelle version de MarshiLM est disponible.",
    upToDate: "À jour",
    unknown: "Inconnu",
  ...
  apiKeys: {
    ...
    description: "Stockez les clés API de manière sécurisée dans la base de données pour activer les fournisseurs d'IA dans MarshiLM.",
